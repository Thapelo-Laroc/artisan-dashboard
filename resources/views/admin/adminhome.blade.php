...
<html
  ...
  <body>
    ...
    <textarea name="description" placeholder="Video Description" required></textarea><br>
    <input type="url" name="youtube_link" placeholder="YouTube Link" required><br>
    <button type="submit">Post Video</button>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">Accounts</h5>
                        <div class="card-body">
                        @if(session('success'))
                        ...
                        @endif
                          <form method="POST" action="{{ route('update.github') }}" enctype="multipart/form-data">
                              @csrf

                              <div class="form-group row">
                                  <label for="file" >{{ __('GitHub Account') }}</label>

                                  <div class="col-md-6">
                                      
                                      <input type="text" name="github" id="github" class="form-control" style="width: 300px;" required>
                                      @error('file')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                        ...
                        <div class="card-body">
                          <form method="POST" action="{{ route('update.twitter') }}" enctype="multipart/form-data">
                              @csrf

                              <div class="form-group row">
                                  <label for="file" >{{ __('X(Twitter) Account') }}</label>

                                  <div class="col-md-6">
                                      
                                      <input type="text" name="twitter" id="twitter" class="form-control" style="width: 300px;" required>
                                      @error('file')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                        ...
                        <div class="card-body">
                          <form method="POST" action="{{ route('update.slack') }}" enctype="multipart/form-data">
                              @csrf

                              <div class="form-group row">
                                  <label for="file" >{{ __('Slack Account') }}</label>

                                  <div class="col-md-6">
                                      
                                      <input type="text" name="slack" id="slack" class="form-control" style="width: 300px;" required>
                                      @error('file')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                ...
                <!-- Projects Submitted by other members/teams -->
                <div class="col-md-6 col-lg-4 col-xl-4 order-2 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                      <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Other Teams' Projects</h5>
                ...
                <div class="col-md-6 col-lg-4 order-0 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Project</h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
                    ...
                    @if (session('status'))
                    <div class="alert alert-success" role="alert" style="margin-left:6%; margin-right:6%">
                        {{ session('status') }}
                    </div>
                @endif
                    <div class="card-body">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                @if (Auth::user()->file_path)
                                    <h5><b>{{ __('Your uploaded project:') }}</b></h5>
    ...
    .then(data => {
        ...
        // Optionally, refresh the calendar to display the new event
